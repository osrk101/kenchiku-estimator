...
public class EstimateController {
	...
	public String createNewEstimate(@Validated EstimateForm estimateForm, BindingResult bindingResult,
		...
		if (estimateForm.getItems() == null || estimateForm.getItems().isEmpty()) {
			bindingResult.rejectValue("items", "NotEmpty", "見積項目を1つ以上追加してください");
		}
	...
	public void removeEmptyItems(EstimateForm estimateForm) {
		...
		items.removeIf(item -> item.getItemName() == null || item.getItemName().isBlank()
